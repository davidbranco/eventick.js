...
var Eventick = require('./src')

Eventick.login('email@eventick.com.br', 'password')
  .then(function(api){
    console.log(api)
    api.events.getList().then(function(response){
...
},{"native-promise-only":3,"superagent":4}],3:[function(require,module,exports){
(function (global){
/*! Native Promise Only
...
},{"../vendor/ramda":12,"kakuna":2}],8:[function(require,module,exports){
var R         = require('../vendor/ramda')
  , Request   = require('kakuna')
...
},{"../vendor/ramda":12,"./atendee":7,"./event":9,"./url":11,"kakuna":2}],9:[function(require,module,exports){
var R              = require('../vendor/ramda')
  , Request        = require('kakuna')
  , endpoint       = require('./url')
...
},{"../vendor/ramda":12,"./url":11,"kakuna":2}],10:[function(require,module,exports){
